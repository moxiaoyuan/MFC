...
BEGIN_MESSAGE_MAP(CImageDlg, CDialogEx)
	...
	ON_BN_CLICKED(IDC_COPY, &CImageDlg::OnBnClickedCopy)
END_MESSAGE_MAP()
...
void CImageDlg::OnBnClickedButton1()
{
   ...
   // SetScrollRange(SB_HORZ,0,(int)(m_width/26.45)-rect.Width());
	SetScrollRange(SB_VERT,0,(int)(m_height/100)-rect.Height());
    SetScrollRange(SB_HORZ,0,(int)(m_width/100)-rect.Width());
    m_picture->Render(*dc,800,10,(int)(m_width/100),(int)(m_height/100),0,m_height,m_width,-m_height,NULL);
...
void CImageDlg::OnBnClickedButton2()
{
    ...
    CRect rect;
    GetClientRect(rect);
    SetScrollRange(SB_VERT,0,(int)(m_height2/100)-rect.Height());
    SetScrollRange(SB_HORZ,0,(int)(m_width2/100)-rect.Width());
    m_picture2->Render(*dc,1,20,(int)(m_width2/100),(int)(m_height2/100),0,m_height2,m_width2,-m_height2,NULL);
	}


void CImageDlg::OnBnClickedCopy()
{
	// TODO: 在此添加控件通知处理程序代码
	CDC* dc = GetDC();
	BOOL m_IsShow;
    ...
    SetScrollRange(SB_VERT,0,(int)(m_height2/100)-rect.Height());
    SetScrollRange(SB_HORZ,0,(int)(m_width2/100)-rect.Width());
    m_picture2->Render(*dc,450,10,(int)(m_width2/100),(int)(m_height2/100),0,m_height2,m_width2,-m_height2,NULL);
	//CRect rect;
	// GetClientRect(rect);
	//SetScrollRange(SB_VERT,0,(int)(m_height/100)-rect.Height());
	// SetScrollRange(SB_HORZ,0,(int)(m_width/100)-rect.Width());
