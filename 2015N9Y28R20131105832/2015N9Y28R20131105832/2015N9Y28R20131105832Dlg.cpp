...
// 2015N9Y28R20131105832Dlg.cpp : 实现文件
//

#include "stdafx.h"
#include "2015N9Y28R20131105832.h"
#include "2015N9Y28R20131105832Dlg.h"
...
// CMy2015N9Y28R20131105832Dlg 对话框




CMy2015N9Y28R20131105832Dlg::CMy2015N9Y28R20131105832Dlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CMy2015N9Y28R20131105832Dlg::IDD, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CMy2015N9Y28R20131105832Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(CMy2015N9Y28R20131105832Dlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_TU1, &CMy2015N9Y28R20131105832Dlg::OnBnClickedTu1)
	ON_BN_CLICKED(IDC_TU2, &CMy2015N9Y28R20131105832Dlg::OnBnClickedTu2)
	ON_BN_CLICKED(IDC_COPY, &CMy2015N9Y28R20131105832Dlg::OnBnClickedCopy)
END_MESSAGE_MAP()


// CMy2015N9Y28R20131105832Dlg 消息处理程序

BOOL CMy2015N9Y28R20131105832Dlg::OnInitDialog()
{
...
void CMy2015N9Y28R20131105832Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CMy2015N9Y28R20131105832Dlg::OnPaint()
{
	if (IsIconic())
	{
...
//显示。
HCURSOR CMy2015N9Y28R20131105832Dlg::OnQueryDragIcon()
{
...
void CMy2015N9Y28R20131105832Dlg::OnBnClickedTu1()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CMy2015N9Y28R20131105832Dlg::OnBnClickedTu2()
{
	// TODO: 在此添加控件通知处理程序代码
	BOOL m_IsShow;//背景图片信息
	m_IsShow=TRUE;
...
void CMy2015N9Y28R20131105832Dlg::OnBnClickedCopy()
{
	// TODO: 在此添加控件通知处理程序代码
	CDC* dc = GetDC();
